...
public class App {
    ...
    public static void main(String[] args) {
        ...
        Company seller = new Company("1234567890", "62-070 Dopiewo, Warszawska 23", "Arek Giernatowski Development");

        List<InvoiceEntry> products = List.of(new InvoiceEntry("Programming course", BigDecimal.valueOf(10000),
